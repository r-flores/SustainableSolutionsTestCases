...
public class TestCase2ACapps {
  ...
  @Test
  public void testCase2ACapps() throws Exception {
    ...
    driver.findElement(By.name("batteryAH")).sendKeys("1200");
    driver.findElement(By.name("batteryDODLimit")).clear();
    driver.findElement(By.name("batteryDODLimit")).sendKeys("15");
    driver.findElement(By.name("batteryCurrentDOD")).clear();
    driver.findElement(By.name("batteryCurrentDOD")).sendKeys("30");
    driver.findElement(By.name("DAY")).clear();
    driver.findElement(By.name("DAY")).sendKeys("30");
    ...
    driver.findElement(By.name("solarHOU")).sendKeys("3");
    ...
    driver.findElement(By.xpath("(//input[@name='DCWatts'])[2]")).sendKeys("60");
    driver.findElement(By.xpath("(//input[@name='DCHOU'])[2]")).clear();
    driver.findElement(By.xpath("(//input[@name='DCHOU'])[2]")).sendKeys("2");
    driver.findElement(By.xpath("//*/text()[normalize-space(.)='AC Appliances']/parent::*")).click();
    driver.findElement(By.xpath("//input[@value='Add addition DC appliance']")).click();
    ...
    driver.findElement(By.xpath("(//input[@name='DCHOU'])[3]")).sendKeys("2");
