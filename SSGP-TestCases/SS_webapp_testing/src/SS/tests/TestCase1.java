...
public class TestCase1 {
  ...
  public void testCase1() throws Exception {
    ...
    driver.findElement(By.name("batteryAH")).sendKeys("1248");
    ...
    driver.findElement(By.name("batteryCurrentDOD")).sendKeys("2");
    ...
    driver.findElement(By.xpath("//fieldset[4]")).click();
    ...
    driver.findElement(By.xpath("(//input[@name='ACWatts'])[2]")).sendKeys("60");
    driver.findElement(By.xpath("(//input[@name='ACHOU'])[2]")).clear();
    driver.findElement(By.xpath("(//input[@name='ACHOU'])[2]")).sendKeys("4");
    Thread.sleep(5000);
