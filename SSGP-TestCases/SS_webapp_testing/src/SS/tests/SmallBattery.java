...
public class SmallBattery {
  ...
  @Test
  public void testSmallBattery() throws Exception {
    ...
    driver.findElement(By.name("batteryAH")).sendKeys("450");
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Battery'])[1]/following::h1[1]")).click();
    driver.findElement(By.name("solarWatts")).click();
    ...
    driver.findElement(By.xpath("(//input[@name='DCWatts'])[2]")).sendKeys("5");
